...
users = [
  {password_digest: "celine", username: "natasha"},
]

User.create(users)

posts = [
  {created_at: DateTime.new, article:"David Zwirner Gallery is a contemporary art gallery in New York City and London owned by David Zwirner that is active in both the primary and secondary markets. From about 2000 to 2012, it was known as Zwirner & Wirth Gallery. Address: 525 W 19th St, New York, NY 10011",title_of_article: "David Zwirner Gallery",image_url: "http://16fdn9ufhox41fwkc1azw8b1bio.wpengine.netdna-cdn.com/wp-content/uploads/2012/09/19th_Street.jpg" },
  {created_at: DateTime.new, article:"The post-World War II period from 1945 until 1970 is recognized as one of the most creative artistic periods of the 20th century, spanning movements from Abstract Expressionism in New York in the 1940s to Pop Art that was popular mainly in England and the United States (from late 1950s to early 1970s).",title_of_article: "Post War and Contemporary Art",image_url:"http://www1.pictures.zimbio.com/gi/Christie+Post+War+Contemporary+Art+Sale+Preview+wV48GuxKuQYl.jpg" },
   {created_at: DateTime.new, article:"BIOGRAPHY. Utilizing fluorescent light tubing available on the commercial market, Dan Flavin created light installations (or “situations” as he preferred to call them) that became icons of Minimalism. Flavin’s wall- and floor-mounted, site-specific fixtures, composed of intersecting and parallel lines of light in conventional colors, flood spaces with their glow. A number of the sculptures feature tubes traversing corners or doorways, or at a right angle to the wall, further engaging the architecture of a room. As Flavin’s installations grew more complex, so too did the spaces built expressly for the purpose of exhibiting them. In 1959, when Flavin was shortly employed as a guard and elevator operator at the Museum of Modern Art, he met fellow Minimalists Sol LeWitt, Robert Mangold, and Robert Ryman.",title_of_article: "Dan Flavin",image_url:"http://images.complex.com/complex/image/upload/t_article_image/dsl7bhnpu2eqis5dajtj.jpg" },
